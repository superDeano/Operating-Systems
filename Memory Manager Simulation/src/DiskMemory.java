...
public class DiskMemory {
    ...
    public synchronized void store(int id, int value) {
        final int indexForId = 0;
        try {
            ...
            while ((line = br.readLine()) != null) {
                ...
                if (Integer.parseInt(line.split("&")[indexForId]) != id) {
                    pw.println(line);
                    pw.flush();
                }
            }
    ...
    public synchronized boolean variableExists(int id) {
        ...
        try {
            ...
            while (fr.hasNext()) {
                currentLine = fr.nextLine();
                if (Integer.parseInt(currentLine.split("&")[indexForId]) == id) {
                    itExists = true;
//                    System.out.println("Variable of ID : " + id + " already exist in Disk");
                    break;
                }
            }
